            ...
            >
              ...
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  >
                    GYD ${act.priceGYD.toLocaleString()}
                  </Badge>
                </div>
              ...
              <a
                ...
                className="mt-auto inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-bold text-white self-start transition-opacity hover:opacity-90"
