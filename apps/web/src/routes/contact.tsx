...
import { contacts, addOns } from "@workspace/shared";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-border p-6">
              <h2 className="font-bold text-lg mb-4">Call or WhatsApp</h2>
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold group-hover:underline">{contacts.phone1}</p>
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold group-hover:underline">{contacts.phone2}</p>
              ...
              <a
                ...
                className="mt-4 w-full flex items-center justify-center gap-2 rounded-xl py-3 font-bold text-white transition-opacity hover:opacity-90"
            ...
            {transport && (
              ...
              >
                <h2 className="font-bold text-lg mb-2">Need a Ride?</h2>
                <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                  We offer door-to-door transport from Georgetown.{" "}
                  <strong style={{ color: "#2D5016" }}>
                    GYD ${transport.priceGYD.toLocaleString()} per trip.
                  </strong>{" "}
          ...
          {/* Right: map */}
          <div className="rounded-2xl overflow-hidden border border-border shadow-sm" style={{ minHeight: 480 }}>
            <iframe
