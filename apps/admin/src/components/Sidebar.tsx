...
export function Sidebar() {
  ...
  return (
    <aside
      className="w-56 shrink-0 flex flex-col h-screen sticky top-0 border-r border-white/10"
    ...
    >
      ...
      <div className="px-5 py-5 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-white font-black text-sm leading-tight">Netsurf</p>
      ...
      <div className="p-3 border-t border-white/10">
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium text-white/45 hover:text-white hover:bg-white/8 transition-all"
        >
